...
TtHeaderView::TtHeaderView(Qt::Orientation orientation, QWidget* parent)
 ...
 */
void TtHeaderView::setHeaderViewWidget(QWidget* widget, int logicalIndex) {
 ...
 */
void TtHeaderView::setSectionHidden(int logicalIndex, bool hide) {
  //先调用父类函数实现默认功能
 ...
 *@param:   logicalIndex:表项的逻辑索引
 */
void TtHeaderView::paintSection(QPainter* painter, const QRect& rect,
