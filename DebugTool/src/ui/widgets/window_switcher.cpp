...
//   const auto refPoint =
//       QPoint(ref(r.left(), r.right(), p.x()), ref(r.top(), r.bottom(),
//       p.y()));
...
// void TabWindow::switchByAlreadyExistingWidget(int tabIndex, const QString
// &uuid,
...
//   for (auto it = widgetInstances.cbegin(); it != widgetInstances.cend();
//   ++it) {
//     if (it.value() == widget) {
//       return it.key();
//     }
...
//   Window::FrameWindow *w = qobject_cast<Window::FrameWindow
//   *>(widget(index)); if (w != nullptr) {
//     if (!w->saveState()) {
//       qDebug() << "no saved";
...
// // void TabWindow::handleButtonClicked(int tabIndex, TtProtocolRole::Role
// role)
// // {
...
// //     auto sendFakeEvent = [mouseEvent](QObject *receiver, QEvent::Type
// type) {
// //       if (!receiver) {
// //         return;
// //       }
...
// //           // Windows with poor openGL driver, there is actually a crash
// when
// //           the
...
//       QMouseEvent e(t, mouseEvent->pos(), Qt::LeftButton,
//       mouseEvent->buttons(),
//                     mouseEvent->modifiers());
